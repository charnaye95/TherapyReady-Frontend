...
const navigate = useNavigate()
  ...
  const deleteClinic = async (id) => {
    await axios.delete(`https://therapyready-backend.herokuapp.com/clinics/${id}`)
    navigate('/clinics')
  }
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        <Route path="/clinics" element={<Clinics clinics={clinics} dataResults={dataResults} />} />
        <Route path="/therapists" element={<Therapists therapists={therapists} dataResults={dataResults}/>} />
